...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-977n0mo.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-977n0mo.containers.anotherwebservice.com/
...
```
git clone git@github.com:VECTORIUSX/container-977n0mo.git
cd container-977n0mo
```
...
```
docker attach container-977n0mo
```
